...
class Anchor(nn.Module):
    ...
    def __init__(self, args, data):
        ...
        self.fc1 = nn.Linear(self.args.f_embedding_dim * 2 + self.args.embedding_dim, 10)
    ...
    def predict_score(self, users, user_features, items, item_features):
        ...
        ui_feature_add = torch.add(user_mapped, item_mapped)
        ui_feature_mul = torch.add(user_mapped, item_mapped)
        ui_feature_cat = torch.cat((u_i, ui_feature_add, ui_feature_mul), dim=1)
